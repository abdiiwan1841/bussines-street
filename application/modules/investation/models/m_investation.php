...
class m_investation extends MY_Model {
	...
	function saveInvestationPlan($params){
	...
	function getDataInvestationByUserId($userid){
		$params=array("userid"=>$userid);
		$sql = "select * from app_bussines where userid=:userid and bussines_role_id=2";
        //$params = array("artikel_konten_id"=>$artikel_konten_id);
        $result = $this->mdb->QueryData('application', $sql, $params, 'record');	
		return $result;
    }
