...
$db['default']['password'] = 'alimin';
$db['default']['database'] = 'bussinesStreet';
...
$db['system']['password'] = 'alimin';
$db['system']['database'] = 'bussinesStreet';
...
$db['application']['password'] = 'alimin';
$db['application']['database'] = 'bussinesStreet';
